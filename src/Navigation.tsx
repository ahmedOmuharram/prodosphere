  ...
  return (
    <>
      ...
      >
        ...
        {menuState === 6 && <Notes/> }
        {menuState === 7 && <Settings setUser={setUser} mapVisibility={mapVisibility} setMapVisibility={setMapVisibility} weatherVisibility={weatherVisibility} setWeatherVisibility={setWeatherVisibility} videoVisibility={videoVisibility} setVideoVisibility={setVideoVisibility} defaultBackground={defaultBackground} setDefaultBackground={setDefaultBackground} secondaryTimezone={secondaryTimezone} setSecondaryTimezone={setSecondaryTimezone}/>}
      </motion.div>
    </>
  )
};
